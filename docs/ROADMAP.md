...
| `R-058` | **One contact per company per day** — two people at Kaiker got near-twin AI emails the same day (2026-09-25); the second waits a day and gets a different angle. | CHANGED 2026-09-25 (D-0046) — proposed ONE contact per company per day; owner chose **two**. Built: a third contact waits for the next day (setting, 0 = off). |
